...
const navItems: NavItem[] = [
  ...
  { href: '/discentes/importacao', label: 'Importar Discentes', icon: <Upload size={20} />, roles: ['CONTROLADOR_GERAL'] },
  ...
  { href: '/importacao', label: 'Importação JSON', icon: <Upload size={20} />, roles: ['CONTROLADOR_PELOTÃO'] },
